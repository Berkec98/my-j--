    ...
    public JExpression analyze(Context context) {
        ...
        if (operand.type() == Type.INT)
            ...
            JAST.compilationUnit.reportSemanticError(line,
                    "Invalid operand types for NegateOp");
        }
    ...
    public JExpression analyze(Context context) {
        if (!(operand instanceof JLhs)) {
            ...
            if (operand.type() == Type.INT)
                ...
                type = Type.ANY;
                JAST.compilationUnit.reportSemanticError(line,
                        "post-- does not support operand type");
            }
        }
        return this;
    }
    ...
    public JExpression analyze(Context context) {
        if (!(operand instanceof JLhs)) {
            ...
            if (operand.type() == Type.INT){
                ...
                type = Type.ANY;
                JAST.compilationUnit.reportSemanticError(line,"pre++ does not support operand " +
                        "type");
            }
        }
        return this;
...
class JUnaryPlusOp extends JUnaryExpression {
    ...
    public JExpression analyze(Context context) {
        ...
        if (operand.type() == Type.INT)
            ...
            type=Type.ANY;
            JAST.compilationUnit.reportSemanticError(line,
                    "Invalid operand types for PositiveOp");
        }
    ...
    public JExpression analyze(Context context) {
        if (!(operand instanceof JLhs)) {
            ...
            if (operand.type() == Type.INT)
                ...
                type = Type.ANY;
                JAST.compilationUnit.reportSemanticError(line,"post++ does not support operand type");
            }
        }
        return this;
    }
