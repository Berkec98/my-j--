        ...
        switch (ch) {
            ...
            case '.':
                ...
                if (!(isDigit(ch))) {
                    ...
                    // If there is a digit after '.' means its a 2nd definition of double literal..
                    buffer = new StringBuffer();
                    buffer.append('.'); //Append initial dot.
                    buffer.append(ch);
                    nextCh();
                    while (isDigit(ch)) {
                        buffer.append(ch);
            ...
            case '&':
                ...
                if (ch == '&') {
                    ...
                    nextCh(); // TODO: I dont get why we need to scan a new char.
            ...
            case '9':
                ...
                // Double Scanner
                    if (ch =='.'){ //First condition of double literals.
                        buffer.append(ch);
                        nextCh();
                        while (isDigit(ch)) {
                            buffer.append(ch);
                        ...
                        //Exponential part of the double (optional)
                    } if ((ch == 'e') || (ch == 'E')) {
                        buffer.append(ch);
                        nextCh();
                        if ((ch == '+') || (ch == '-')) {
